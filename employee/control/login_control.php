    ...
    if (file_exists($file_path)) {
        ...
        foreach ($users as $user) {
            if ($user['email'] === $email && $user['password'] === $password) {
                ...
                $_SESSION['employee_logged_in'] = true; // Employee-specific session variable
                ...
                if ($result_check->num_rows == 0) {
                    ...
                    $sql_insert = "INSERT INTO employee (Name, Email, Password, Gender) VALUES (?, ?, ?, ?)";
                    ...
                    if ($stmt_insert) {
                        ...
                        if ($stmt_insert->execute()) {
                            $_SESSION['message'] = "Welcome! Your account has been successfully logged in.";
                        } else {
                ...
                // Redirect to the Employee Dashboard instead of home.php
                header('Location: ../view/employee_dashboard.php');
                exit;
            }
        }

        $_SESSION['error_message'] = " password is incorrect. Please try again.";
    } else {
